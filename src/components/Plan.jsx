  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, non!</p>
        <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut similique reiciendis in! Eos ipsum adipisci sint impedit repudiandae expedita, minus, quaerat velit illum numquam consectetur minima, iusto tempora tempore deleniti.</p>
        <div>
          <button className='border-black mr-4 hover:shadow-xl'>Learn More</button>
          <button className='bg-black text-white border-black hover:shadow'>Book Your Trip</button>
        </div>
      </div>
    </div>
  )
